...
This is an experiment to mathematically model evolution.

This was originally to be a coding sandbox, but the designer turned it into a miniature science experiment, where they attempted to build a couple of mathematical models of evolution, in particular how genes can change over time. Vectors are used to simulate genomes, and the numbers are the 'genes.' 
